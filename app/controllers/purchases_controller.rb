class PurchasesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @purchase.save
        format.html { redirect_to @purchase.receipt, notice: 'Purchase was successfully created.' }
  ...
  def destroy
    ...
    @purchase.destroy
    respond_to do |format|
      format.html { redirect_to receipt, notice: 'Purchase was successfully destroyed.' }
