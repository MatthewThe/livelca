...
function drawDailyBudget(val) {
  ...
  var height = groupSpacing * vertGroups + (cellSpacing + cellSize) * (vertWithinGroups + vertGroups * 10);
  ...
  var enterSel = join.enter()
    ...
    .attr("y", function(d, i) {  
      ...
      return groupSpacing * vertGroupOffset + (cellSpacing + cellSize) * (vertWithinGroupOffset + vertGroupOffset * 10); 
    })  
    .attr('width', 0)  
    .attr('height', 0);
